...
import FlowStateEngine from "./FlowStateEngine";
        ...
        {tab==="nutrition"&&(
          <div style={{padding:"16px 20px 32px"}}>
            ...
            <div style={{display:"flex",gap:4,marginBottom:16}}>
              {[1,2,3,4].map(p=>(
                <button key={p} onClick={()=>setMealPhase(p)} style={{flex:1,padding:"8px 0",borderRadius:8,cursor:"pointer",fontSize:10,fontWeight:700,
            ...
            <div style={{display:"flex",gap:4,marginBottom:14}}>
              {["breakfast","lunch","dinner","snacks"].map(f=>(
                <button key={f} onClick={()=>setRecipeFilter(f)} style={{flex:1,padding:"7px 0",borderRadius:8,cursor:"pointer",fontSize:10,fontWeight:600,textTransform:"capitalize",
